...
void scan_input_debug(void)
{
  ...
  for (cnt = 0; cnt < 4; cnt++)
  {
    /*
        ...
        col 4: 0 0 0 1
    */
    digitalWrite(col[cnt % 4], HIGH);
    digitalWrite(col[(cnt + 1) % 4], LOW);
    digitalWrite(col[(cnt + 2) % 4], LOW);
    digitalWrite(col[(cnt + 3) % 4], LOW);
